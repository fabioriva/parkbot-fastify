...
const group1 = new AlarmGroup([], 'EL1')
const group2 = new AlarmGroup([], 'EL2')
const group3 = new AlarmGroup([], 'E1')
const group4 = new AlarmGroup([], 'E2')
const group5 = new AlarmGroup([], 'U1')
const group6 = new AlarmGroup([], 'U2')
for (let i = 0; i < 64; i++) {
  group1.alarms.push(
